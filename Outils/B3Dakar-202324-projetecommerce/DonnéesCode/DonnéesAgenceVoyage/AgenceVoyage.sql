...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 03 oct. 2023 à 12:33
...
CREATE TABLE IF NOT EXISTS `aeroports` (
  ...
  `nomAeroport` varchar(77) DEFAULT NULL,
...
INSERT INTO `aeroports` (`iata_code`, `nomAeroport`, `ville`, `region`, `pays`, `latitude`, `longitude`) VALUES
...
CREATE TABLE IF NOT EXISTS `compagnies` (
  ...
  `compagnie` varchar(28) DEFAULT NULL,
  PRIMARY KEY (`IATA_CODE`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
INSERT INTO `compagnies` (`IATA_CODE`, `compagnie`) VALUES
...
CREATE TABLE IF NOT EXISTS `vols` (
  ...
  `heureDepart` varchar(4) NOT NULL,
  `heureArrivee` varchar(4) NOT NULL,
  `noCompagnie` varchar(2) NOT NULL,
  `aeroportDepart` varchar(3) NOT NULL,
  `aeroportArrivee` varchar(3) NOT NULL,
